...
default_logging_pattern = '%(relativeCreated)d\t %(levelname)s\t %(process)d %(funcName)s@%(filename)s:%(lineno)d : %(message)s';

def init_logging(loglevel=logging.DEBUG, pylearn2_loglevel=logging.WARN):
